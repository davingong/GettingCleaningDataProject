## This following folder contains a script, "run_analysis.R," that cleans and consolidates the UCI HAR dataset. In addition, it contains the dataset's original raw files
